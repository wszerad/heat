...
},{"./models/programs.js":2}],2:[function(require,module,exports){
module.export = function(){
	var turbineSpeeds=[30, 40, 50, 60, 70, 80, 90, 100];

	var heat={
		parameters: [{
			name: 'temp', printName: 'pokojowa', type: 'range', def: {
				day: 0, night: 0, water: 0, standby: 0, stop: 0
			}, step: 1, min: 0, max: 26
		}, {
			name: 'cycTemp', printName: 'kotła', type: 'range', def: {
				day: 0, night: 0, water: 0, standby: 0, stop: 0
			}, step: 1, min: 0, max: 90
		}, {
			name: 'coTemp', printName: 'co', type: 'range', def: {
				day: 0, night: 0, water: 0, standby: 0, stop: 0
			}, step: 1, min: 0, max: 90
		}, {
			name: 'helixWork', printName: 'czas podawania', type: 'range', def: {
				day: 0, night: 0, water: 0, standby: 0, stop: 0
			}, step: 1, min: 0, max: 240
		}, {
			name: 'helixStop', printName: 'przerwa podawania', type: 'range', def: {
				day: 0, night: 0, water: 0, standby: 0, stop: 0
			}, step: 1, min: 0, max: 240
		}, {
